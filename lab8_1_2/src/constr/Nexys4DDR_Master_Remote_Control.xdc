...
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { val[0] }]; # Sch = SW0
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { val[1] }]; # Sch = SW1
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { val[2] }]; # Sch = SW2
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { val[3] }]; # Sch = SW3
...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { ten }]; #IO_L18P_T2_A24_15 Sch=led[0]
