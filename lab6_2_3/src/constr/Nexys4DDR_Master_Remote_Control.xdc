...
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { load }]; # Sch = SW0
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { enable }]; # Sch = SW1
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { clear }]; # Sch = SW2
